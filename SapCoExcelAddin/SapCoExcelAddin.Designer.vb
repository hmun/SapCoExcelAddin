...
Partial Public NotInheritable Class SapCoExcelAddin
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SapCoExcelAddin As SapCoExcelAddin
    ...
    Friend Shared Property SapCoExcelAddin() As SapCoExcelAddin
        Get
            Return _SapCoExcelAddin
        End Get
        Set
            If (_SapCoExcelAddin Is Nothing) Then
                _SapCoExcelAddin = value
            Else
    ...
    Friend Shared Property ThisAddIn() As SapCoExcelAddin
        Get
            Return _SapCoExcelAddin
        End Get
        Set
