...
Public Class SAPAcctngRepstPrimCosts
    ...
    Private cName As String = "SAPAcctngRepstPrimCosts"
    ...
    Public Function Post(pData As TSAP_Data_Co, Optional pOKMsg As String = "OK", Optional pCheck As Boolean = False) As String
        ...
        Try
            ...
            Dim oSEND_CRITERIA As IRfcTable = oRfcFunction.GetTable("SEND_CRITERIA")
            Dim oREC_CRITERIA As IRfcTable = oRfcFunction.GetTable("REC_CRITERIA")
            Dim oCUSTOMER_FIELDS As IRfcTable = oRfcFunction.GetTable("CUSTOMER_FIELDS")
            oDOC_ITEMS.Clear()
            oRETURN.Clear()
            oSEND_CRITERIA.Clear()
            oREC_CRITERIA.Clear()
            ...
            pData.aDataDic.to_IRfcTable(pKey:="SEND_CRITERIA", pIRfcTable:=oSEND_CRITERIA)
            pData.aDataDic.to_IRfcTable(pKey:="REC_CRITERIA", pIRfcTable:=oREC_CRITERIA)
